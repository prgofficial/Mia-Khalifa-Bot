...
import miakhalifa.modules.sql.locks_sql as sql
from miakhalifa import dispatcher, SUDO_USERS, DEV_USERS, LOGGER
from miakhalifa.modules.disable import DisableAbleCommandHandler
from miakhalifa.modules.helper_funcs.chat_status import can_delete, is_user_admin, user_not_admin, user_admin, bot_can_delete, is_bot_admin, connection_status
from miakhalifa.modules.helper_funcs.filters import CustomFilters
from miakhalifa.modules.log_channel import loggable
from miakhalifa.modules.sql import users_sql
