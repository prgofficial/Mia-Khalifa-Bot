...
import miakhalifa.modules.sql.global_bans_sql as sql
from miakhalifa import dispatcher, OWNER_ID, DEV_USERS, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, GBAN_LOGS, STRICT_GBAN, spam_watch
from miakhalifa.modules.helper_funcs.chat_status import user_admin, is_user_admin
...
from miakhalifa.modules.helper_funcs.misc import send_to_list
from miakhalifa.modules.sql.users_sql import get_all_chats
