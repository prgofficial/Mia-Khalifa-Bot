...
import miakhalifa.modules.sql.connection_sql as sql
from miakhalifa import dispatcher, SUDO_USERS, DEV_USERS, spamfilters
from miakhalifa.modules.helper_funcs import chat_status
